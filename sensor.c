...
/* Filename: sensor.c
* Project: RAW
* Description: Source code of Sensor driver
* Author: HengJun (MTK70677)
*             HISTORY
...
* [Camera]
1. Modify the AE converge speed in the video mode.
...
static void OV5647_Sensor_Init(void)
{
    ...
    OV5647_write_cmos_sensor(0x3011, 0x62);//0x42
...
static void OV5647_Sensor_1M(void)
{
    ...
    OV5647_write_cmos_sensor(0x3821, 0x01); /*  timing tc reg21 */
    OV5647_write_cmos_sensor(0x3820, 0x47); /*  timing tc reg20 */
...
static void OV5647_Sensor_5M(void)
{
    ...
    //OV5647_write_cmos_sensor(0x350d, 0x00);
    //OV5647_write_cmos_sensor(0x3503, 0x03);  //;manual AE
    OV5647_write_cmos_sensor(0x3821, 0x01);
